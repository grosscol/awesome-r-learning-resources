...
- [Data Wrangling and Visualization with R](https://rafalab.dfci.harvard.edu/dsbook-part-1/) - Part one of a two part series, Introduction to Data Science, this book started out as the class notes used in the HarvardX Data Science Series. It introduces concepts and skills that can help you tackle real-world data wrangling using dplyr and visualization challenges using ggplot2. Author: Professor Rafael A. Irizarry.
- [Statistics and Prediction Algorithms Through Case Studies](https://rafalab.dfci.harvard.edu/dsbook-part-2/) - Part two of a two part series, Introduction to Data Science, this book continues to cover the topics: summary statistics, probability, statistical inference, linear models, high dimensional data, and machine learning. Author: Professor Rafael A. Irizarry.
